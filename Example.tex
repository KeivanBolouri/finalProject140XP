...
can accommodate, this test confirms that a negative binomial
regression---which includes an additional dispersion parameter---is more
appropriate.
...
\subsection{1.Statistical Method for Civilian Harm
Difference:}\label{statistical-method-for-civilian-harm-difference}
...
\subsection{2.Statistical Method for Drone Effectiveness Across
Countries:}\label{statistical-method-for-drone-effectiveness-across-countries}
...
\subsection{3.Statistical Method for Reporting Uncertainty
Differenc:}\label{statistical-method-for-reporting-uncertainty-differenc}
...
\chapter{Results of Statistical
Tests}\label{results-of-statistical-tests}
...
\pandocbounded{\includegraphics[keepaspectratio]{Example_files/figure-pdf/unnamed-chunk-9-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Example_files/figure-pdf/unnamed-chunk-10-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Example_files/figure-pdf/unnamed-chunk-11-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Example_files/figure-pdf/unnamed-chunk-12-1.pdf}}

\section{Visualization (Test 3)}\label{visualization-test-3}

\pandocbounded{\includegraphics[keepaspectratio]{Example_files/figure-pdf/unnamed-chunk-13-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Example_files/figure-pdf/unnamed-chunk-14-1.pdf}}
